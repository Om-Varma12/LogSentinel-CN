  ...
  <span className="text-emerald-500">automation</span>:
    ...
    <span className="text-emerald-500">orchestration</span>: true
        ...
        <footer className="pt-12 border-t border-white/5 flex items-center justify-between mb-20">
          <a href="#welcome" className="group flex flex-col gap-1" onClick={(e) => { e.preventDefault(); document.getElementById('welcome')?.scrollIntoView({ behavior: 'smooth' }); }}>
        ...
        {/* Footer Branding */}
        <footer className="pt-32 pb-12 border-t border-white/5 flex flex-col items-center gap-6 mt-20">
          <div className="font-serif text-2xl italic tracking-tighter opacity-80">Log-Sentinel Documentation.</div>
          <p className="text-[9px] font-tech uppercase tracking-[0.5em] text-white/10 italic">
            Architected by Neural Dynamics // v2.4-STABLE
          </p>
        </footer>
