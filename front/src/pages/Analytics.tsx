...
export default function Analytics() {
  ...
  return (
    <motion.div
      ...
      className="h-screen w-full flex flex-col bg-soc-bg overflow-hidden"
    >
      {/* Fixed Header */}
      <motion.div
        ...
        className="shrink-0 bg-soc-bg/95 backdrop-blur-sm border-b border-soc-border px-6 py-4"
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-soc-text-tertiary">Real-time incident insights</p>
            </div>
          </div>
            ...
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip content={<ChartTooltipContent hideLabel indicator="dot" payload={severityData} />} />
                </PieChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={timeSeriesData}>
                  ...
                  <Tooltip content={<ChartTooltipContent hideLabel indicator="dot" payload={timeSeriesData} />} />
                  <Area
                    type="monotone"
                    dataKey="high"
                    stackId="1"
            ...
            <div className="h-[180px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={mitreData} layout="vertical">
                  ...
                  <Tooltip content={<ChartTooltipContent hideLabel indicator="dot" payload={mitreData} />} />
            ...
            <div className="h-[180px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip content={<ChartTooltipContent hideLabel indicator="dot" payload={actionData} />} />
                </PieChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={endpointData}>
                  ...
                  <YAxis tick={{ fontSize: 10, fill: "#71717a" }} />
                  <Tooltip content={<ChartTooltipContent hideLabel indicator="dot" payload={endpointData} />} />
