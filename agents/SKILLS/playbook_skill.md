...
|-----------|----------|------------------------------|-----------------------|
| 0–29.9    | 🟢 Low    | Observe, log for pattern     | Close / Flag          |
| 30–59.9   | 🟡 Medium | Investigate actively         | Flag / Open ticket    |
| 60–79.9   | 🔴 High   | Contain the IP               | Open ticket / Escalate|
| 80–100    | 🚨 Critical | Isolate + escalate now     | Escalate immediately  |
